...
public class BestCurrentExchangeRate {
    public static void main(String[] args) {
        List<Node> data = new ArrayList<Node>();
        data.add(new Node("USD", "JPY", 110));
        data.add(new Node("USD", "AUD", 1));
        data.add(new Node("AUD", "MOS", 4));
        data.add(new Node("MOS", "JPY", 200));
        System.out.println(getRatio("USD", "MOS", data));
    }
