package com.pc.interview.questions.coinbase;
...
/**
 * Write a program to implement a Connect4Game such that as soon as player connects 4 dots in a row then the player wins.
 */
public class Connect4Game {
    ...
    // get string representation of the col containing
    // the last play of the user
