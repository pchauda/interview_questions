package com.pc.interview.questions.cracking_the_coding_interview.math_puzzles;

import java.util.Arrays;

/**
 * <p>There are 100 closed lockers in a hallway. A man begins by opening all 100 lockers.
 ...
 * #100, how many lockers are open?</p>
 *
 * Approach: <br/>
 *  Total number of lockers that will be open at the end will be equal to number of numbers that will result into a
 *  perfect square between 1 and 100 (both inclusive)
