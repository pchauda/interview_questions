package com.pc.interview.questions.cracking_the_coding_interview.stacks_queues;

import java.util.Stack;

/**
 * <p>Sort a given stack only by using just one another stack. Can't use any other data structure like arrays, queue etc.</p>
 * <p>
 * Approach: <br/>
...
public class SortAStackUsingOnlyAnotherStack {
    ...
    public static void main(String[] args) {
        ...
        sortStack(stack);
        System.out.println("Sorted stack: " + stack); // Stack top contains the lowest element and so on
