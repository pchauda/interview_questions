package com.pc.interview.questions.cracking_the_coding_interview.linked_lists;

import static com.pc.interview.questions.cracking_the_coding_interview.linked_lists.LinkedListNode.printList;
...
public class DeleteAnyMiddleNode {
    ...
    // ask the interviewer if the Node class can be modified to use a flag for dummy nodes and mark the last node as dummy in this case.
