package com.pc.interview.questions.programs;
...
public class EggDropProblem {
    ...
    public static void main(String[] args) {
       // System.out.println("Minimum attempts: " + obj.eggDrop(2, 10)); // Output: 4
        System.out.println("Minimum attempts (DP): " + obj.eggDropUsingDp(2, 100)); // Output: 14
    }
    ...
    public int eggDropUsingDp(int eggs, int floors) {
        ...
        for(int[] arr : eggFloor) {
            Arrays.fill(arr, Integer.MAX_VALUE); // initialize with max trials
        }
        // base cases for eggs
        ...
        // calculate minimum attempts required using optimal substructure property
